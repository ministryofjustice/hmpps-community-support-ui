...
export interface paths {
    ...
    "/referral/{referralReference}/withdraw": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Withdraw a referral */
        post: operations["withdrawReferral"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        WithdrawReferralRequest: {
            /** @enum {string} */
            reasonCode: "INELIGIBLE_REFERRAL" | "MISTAKEN_OR_DUPLICATE_REFERRAL" | "NOT_ENGAGED" | "NEEDS_MET_THROUGH_ANOTHER_ROUTE" | "USER_DIED" | "WORK_CARING_COMMITMENTS_OR_SICKNESS" | "ACQUITTED_ON_APPEAL" | "RETURNED_TO_CUSTODY" | "SENTENCE_REVOKED" | "SENTENCE_EXPIRED" | "OTHER_CHANGE_OF_CIRCUMSTANCE";
            additionalDetails?: string | null;
        };
        ...
        AdditionalSupportNeedsBffResponseDto: {
            ...
            mentalEmotionalHealth: components["schemas"]["No"] | components["schemas"]["Unanswered"] | components["schemas"]["Yes"];
            ...
            caringResponsibilities: components["schemas"]["No"] | components["schemas"]["Unanswered"] | components["schemas"]["Yes"];
            employmentResponsibilities: components["schemas"]["No"] | components["schemas"]["Unanswered"] | components["schemas"]["Yes"];
...
export interface operations {
    ...
    withdrawReferral: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WithdrawReferralRequest"];
            };
        };
        responses: {
    ...
    updateMainPointOfContactDetails: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    updateAdditionalInformationForTheDeliveryPartner: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["No"] | components["schemas"]["Unanswered"] | components["schemas"]["Yes"];
            };
        };
        responses: {
